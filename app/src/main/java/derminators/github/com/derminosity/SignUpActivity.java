...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createAccount() {
        ...
        final String userStatus = userType.getSelectedItem().toString();
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                .addOnSuccessListener(this, new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        saveData(uid, email, firstName, lastName, userStatus, hospital);
                    }
                })
    ...
    private void saveData(String uid, String email, String firstName, String lastName, String userStatus, String hospital) {
        if (userStatus.equals("Doctor")) {
            ...
            db.collection("doctors").document(email)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.d("saveData", "Doctor successfully written!");
                    }
                })
            ...
            Patient patient = new Patient(uid, firstName, lastName);
            db.collection("patients").document(email)
                    .set(patient)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Log.d("saveData", "Patient successfully written!");
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
