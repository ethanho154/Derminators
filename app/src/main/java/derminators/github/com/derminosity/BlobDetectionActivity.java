...
public class BlobDetectionActivity extends AppCompatActivity implements OnTouchListener {
...
//    private static final int PERMISSION_REQUEST_CODE = 200;
    ...
    private void onImageLoaded() {
        ...
        processedBitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Bitmap.Config.ARGB_8888);
